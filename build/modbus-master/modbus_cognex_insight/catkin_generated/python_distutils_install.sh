...
echo_and_run cd "/home/weber/test_ws/src/modbus-master/modbus_cognex_insight"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/weber/test_ws/src/modbus-master/modbus_cognex_insight/setup.py" \
     \
    build --build-base "/home/weber/test_ws/build/modbus-master/modbus_cognex_insight" \
    install \
    --root="${DESTDIR-/}" \
