...
echo_and_run cd "/home/weber/test_ws/src/modbus-master/modbus_plc_siemens"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/weber/test_ws/src/modbus-master/modbus_plc_siemens/setup.py" \
     \
    build --build-base "/home/weber/test_ws/build/modbus-master/modbus_plc_siemens" \
    install \
    --root="${DESTDIR-/}" \
